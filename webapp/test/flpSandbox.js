		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comnickchecansampleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comnickchecansampleapp-display": {
								"semanticObject": "comnickchecansampleapp",
								"action": "display",
								"description": "Sample Freestyle SAPUI5 app for testing",
								"title": "Sample Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.nickchecan.sampleapp",
									"url": sap.ui.require.toUrl("com/nickchecan/sampleapp")
								}
							}
						}
					}
